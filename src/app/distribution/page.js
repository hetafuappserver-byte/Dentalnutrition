        ...
        <section className="w-full border-t border-b border-[#401e17]">
          <div className="mx-auto max-w-[1200px] px-5 py-10 text-center md:px-8 md:py-14">
            ...
            <p className="mx-auto max-w-[820px] text-lg leading-[1.65]">
              ...
              <a href="mailto:reachthebest@hetafu.com" className="underline hover:no-underline">reachthebest@hetafu.com</a>
              {` or `}
              <a href="tel:+918106989955" className="underline hover:no-underline">+91 8106989955</a>.
            </p>
          </div>
        </section>

        <section className="w-full border-b border-[#401e17]" aria-label="Hetafu office location map">
