            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  <span className="text-[#02c3c2] font-bold mt-1">✓</span>
                  <span className="text-sm">Clinically Proven Ingredients</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#02c3c2] font-bold mt-1">✓</span>
                  <span className="text-sm">Expert-Backed Formulation</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#02c3c2] font-bold mt-1">✓</span>
                  <span className="text-sm">Transparency at Every Step</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#02c3c2] font-bold mt-1">✓</span>
                  <span className="text-sm">No Artificial Additives or Preservatives</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#02c3c2] font-bold mt-1">✓</span>
                  <span className="text-sm">Trusted by Parents & Recommended by Experts</span>
                </li>
              </ul>
      ...
      <section className="mx-auto max-w-[1200px] px-4 sm:px-5 py-8 sm:py-10 md:px-8 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {CARDS.map((card) => (
            <article
              key={card.no}
              className="flex flex-col items-stretch gap-4 sm:gap-5 text-start"
            >
              ...
              <div className="flex w-full flex-col items-start gap-3 sm:gap-4">
                ...
                <h2 className="m-0 [font-family:var(--heading-font)] text-base sm:text-lg font-normal tracking-[0.04em]">
                  {card.title}
                </h2>
