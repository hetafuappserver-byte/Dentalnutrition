...
const OVERLAY_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      "🧠 Brain fog — Oral microbial imbalance impairs cognitive function (focus, memory, and mental ability).",
    ],
    image: IMAGES.overlay3,
  },
  {
    ...
    paragraphs: [
      "🦠 IBS & bloating — Harmful oral bacteria can travel to the gut, alter gut microbial balance, and promote intestinal inflammation linked with IBS and related digestive disorders.",
    ],
    image: IMAGES.overlay2,
  },
  {
    ...
    paragraphs: [
      "🫘 Kidney infections — Harmful oral bacteria can travel through the blood and overload the kidneys.",
    ],
    image: IMAGES.overlay3,
  },
  {
    ...
    paragraphs: [
      "🧬 Cancers — Long-term oral microbial imbalance can damage DNA (Breast, lung, stomach).",
    ],
    image: IMAGES.overlay2,
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "🤰 Pregnancy complications — Harmful oral bacteria increase the risk of early birth and low birth weight.",
    ],
    image: IMAGES.overlay2,
  },
  {
...
export default function DentalNutrition() {
  return (
