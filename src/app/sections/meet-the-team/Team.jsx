...
function TeamModal({ member, onClose }) {
  ...
  return (
    ...
    >
      ...
      />
      <div 
        className="relative m-0 max-h-[90vh] w-full max-w-[900px] overflow-y-auto bg-white rounded-lg"
      >
        <button
          type="button"
          ...
          <div>
            ...
            {member.instagram && (
              <p className="mb-6">
                ...
                >
                  <Instagram width={20} /> {member.instagramHandle}
                </a>
              </p>
            )}
              ...
              <div className="flex flex-wrap justify-center gap-x-5 gap-y-8 min-[700px]:gap-x-8 min-[700px]:gap-y-10">
                {section.members.map((member) => (
                  ...
                  >
                    ...
                    <p className="m-0 mt-1.5 text-center text-sm leading-[1.4] opacity-75 min-[700px]:text-base">
                      {member.gridRole}
                    </p>
                  </button>
                ))}
