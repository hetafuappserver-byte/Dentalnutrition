...
import { BITS_COLLECTION, BITS_PRODUCTS, getBitsProduct } from "./bitsProducts";
...
export function ProductDetail({ product, category = "bits" }) {
          ...
          <div className="mo-product-detail__info">
            <nav className="mo-product-detail__breadcrumb" aria-label="Breadcrumb">
              <ol>
                ...
                <li>
                  <Link href={BITS_COLLECTION.href}>{BITS_COLLECTION.title}</Link>
                </li>
        ...
        <section className="mo-product-detail__related" aria-label="Related products">
          ...
          <div className="mo-product-grid">
            {product.related.map((item) => {
              const relatedProduct = getBitsProduct(item.slug);
